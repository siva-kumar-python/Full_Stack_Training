...
var department={
    "MCA":["CO","DCCN","Python","Python Ds"],
    "MBA":["Marketing","Finance","HR","Finance"],
    "MTECH":["Data Science","Machine Learning","Cloud Computing","Data Science"],
}
window.onload=function(){
    var sdept=document.getElementById("dept");
    var ssub=document.getElementById("sub");
    for(var i in department){
        sdept.options[sdept.options.length]=new Option(i);
    }
    sdept.onchange=function(){
        ssub.length=1;
       var real=department[this.value];
       for (var i=0;i<real.length;i++){
        ssub.options[ssub.options.length]=new Option(real[i]);
       }
...
var d= parseInt(document.getElementById("facAge").value);
if(d<18 || d>65 || isNaN(d) == true){ alert("invalid age ");return false;}
 var e= document.getElementById("facPlace").value;
if(e== ""|| e==null || isNaN(a)== false){ alert("invalid place ");return false;}
